...
+ (id)descriptorWithURL:(NSURL *)aURL
{
	...
	return [self descriptorWithDescriptorType:typeFileURL data:[NSData dataWithBytes:[urlString UTF8String] length:[urlString lengthOfBytesUsingEncoding:NSUTF8StringEncoding]]];
}
